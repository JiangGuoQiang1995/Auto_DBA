...
namespace Evaluation {
    ...
    // This interface is implemented by AD7 IDebugProperty3 objects, and provides access to 
    // the underlying DkmFailedEvaluationResult. 
    interface DECLSPEC_NOVTABLE DECLSPEC_UUID("DB11FB3F-6E0E-4F66-A948-87915857DB03") IVsWrappedDkmFailedEvaluationResult : public IUnknown
    {
        // Gets the underlying DkmFailedEvaluationResult.
        // If there is no backing DkmFailedEvaluationResult, this method will return S_FALSE.
        virtual HRESULT STDMETHODCALLTYPE GetDkmFailedEvaluationResult(
            _Deref_out_opt_ class DkmFailedEvaluationResult** ppDkmFailedEvaluationResult
        ) = 0;
    };
};
