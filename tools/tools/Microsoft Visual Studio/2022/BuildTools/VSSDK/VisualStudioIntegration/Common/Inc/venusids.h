...
// {9C5B3619-FD0B-467C-B06D-FBEB1496FB1A}
...
// {9C5B3619-FD0B-467C-B06D-FBEB1496FB1A}
#define guidDotNetCoreWebCmdId { 0x9C5B3619, 0xFD0B, 0x467C, { 0xB0, 0x6D, 0xFB, 0xEB, 0x14, 0x96, 0xFB, 0x1A } };
...
// asp.net core comamand id
#define cmdidManageUserSecrets       0x700
