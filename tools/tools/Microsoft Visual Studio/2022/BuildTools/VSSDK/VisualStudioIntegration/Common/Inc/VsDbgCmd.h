...
#define IDM_MODULES_COPY_SUBMENU           0x041B
#define IDM_BREAKPOINTGROUPS               0x041C
#define IDM_BREAKPOINTGROUPS_EDITOR        0x041D
...
#define IDM_MODULES_OPEN_SUBMENU            0x0448
#define IDM_CALLSTACK_WINDOW_TOOLBAR        0x0449
...
#define IDM_GUTTER_BREAKPOINT_CONTEXT      0X0517
#define IDM_VISUALIZER_CONTEXT          0X0518
...
#define IDG_GUTTER_BREAKPOINT_CONTEXT          0x0022
#define IDG_VISUALIZER_CONTEXT              0x0023
...
#define IDG_MODULES_COPY_SUBMENU           0x0176
#define IDG_AUTOS_WINDOW_SEARCH            0x0177
#define IDG_LOCALS_WINDOW_SEARCH           0x0178
#define IDG_WATCH_WINDOW_SEARCH            0x0179
#define IDG_WATCH_WINDOW_SEARCH1           0x017a
#define IDG_WATCH_WINDOW_SEARCH2           0x017b
#define IDG_WATCH_WINDOW_SEARCH3           0x017c
#define IDG_WATCH_WINDOW_SEARCH4           0x017d

#define IDG_DATATIP_DATA_BREAKPOINT        0x017e
#define IDG_DATA_BREAKPOINT                0x017f

#define IDG_OBJECT_FAVORITES                      0x0180
#define IDG_AUTOS_WINDOW_OBJECT_FAVORITES         0x0181
#define IDG_LOCALS_WINDOW_OBJECT_FAVORITES        0x0182
#define IDG_WATCH_WINDOW_OBJECT_FAVORITES1        0x0183
#define IDG_WATCH_WINDOW_OBJECT_FAVORITES2        0x0184
#define IDG_WATCH_WINDOW_OBJECT_FAVORITES3        0x0185
#define IDG_WATCH_WINDOW_OBJECT_FAVORITES4        0x0186

#define IDG_EXTENDED_SIDE_EFFECTS       0x0187

#define IDG_MODULES_DECOMPILATION       0x0188

#define IDG_MODULES_OPEN_SUBMENU        0x0189
#define IDG_CALLSTACK_WINDOW_SEARCH     0x018a
#define IDG_CALLSTACK_PARALLEL_STACKS   0x018b
#define IDG_CALLSTACK_EXTERNAL_CODE     0x018c
...
#define IDG_REVERSE_STEPPING            0x0402
#define IDG_DEBUG_TOOLBAR_REVERSE_STEPPING      0x0403

#define IDG_BREAKPOINTGROUPS            0x404
#define IDG_BREAKPOINTS_WINDOW_BREAKPOINTGROUPS    0x405
#define IDG_BREAKPOINTGROUPS_EDITOR     0x406
#define IDG_EDITOR_BREAKPOINTGROUPS     0x407

#define IDG_DEBUGGER_COPILOT            0x408
...
#define cmdidInsertTemporaryBreakpoint      0x00000042
#define cmdidInsertConditionalBreakpoint    0x00000043
#define cmdidDeleteBreakpoint               0x00000044
#define cmdidInsertDependentBreakpoint      0x00000045
...
#define cmdidBreakpointSettingsQuick        0x00000142
...
#define cmdidBreakWhenValueChanges          0x000001A0
#define cmdidIsObjectFavorite               0x000001A1
#define cmdidShowOnlyFavorites              0x000001A2
#define cmdidShowFavoritesNames             0x000001A3
#define cmdidEnableExtendedSideEffects      0x000001A4
#define cmdidDecompileSource                0x000001A5
#define cmdidExtractEmbeddedSource          0x000001A6
#define cmdidForceRunToCursor               0x000001A7
#define cmdidNewBreakpointGroup             0x000001A8
#define cmdidOpenVisualizer                 0x000001A9

// Breakpoint commands in the editor gutter
#define cmdidInsertTemporaryBreakpointFromGutterContextMenu     0x000001B0
#define cmdidInsertConditionalBreakpointFromGutterContextMenu   0x000001B1
#define cmdidInsertTracepointFromGutterContextMenu              0x000001B2
#define cmdidInsertDependentBreakpointFromGutterContextMenu     0x000001B3
...
#define cmdidBreakpointsWindowFilterFocus       0x0000110C
...
// The expression evaluation windows commands are arranged in groups.
// The command handling side masks out the upper 2 bytes and compares
// the incoming command with the known base begin and end command ids
// to determine which EE window should handle the command. For the
// Watch windows, the upper 2 bytes represent the specific numbered
// window.
//
// Example:
// int ToolWindowId = cmdid >> 24;
// int BaseCommandId = cmdid & 0x0000ffff;
// if (cmidWatchFirst >= BaseCommand && BaseCommand <= cmdidWatchLast)
//     GetWatchWindowHandler(ToolWindowId)->HandleCommand(cmdid);
#define cmdidAutosFirst                     0x0000e000
#define cmdidAutosRealFuncEval              0x0000e000
#define cmdidAutosSearchDepth               0x0000e001
#define cmdidAutosSearchDepthList           0x0000e003
#define cmdidAutosSearchNext                0x0000e004
#define cmdidAutosSearchPrevious            0x0000e005
#define cmdidAutosSearchFocus               0x0000e006
#define cmdidAutosShowOnlyFavorites         0x0000e007
#define cmdidAutosShowFavoritesNames        0x0000e008
#define cmdidAutosLast                      0x0000e01f

#define cmdidLocalsFirst                    0x0000e020
#define cmdidLocalsRealFuncEval             0x0000e020
#define cmdidLocalsSearchDepth              0x0000e021
#define cmdidLocalsSearchDepthList          0x0000e023
#define cmdidLocalsSearchNext               0x0000e024
#define cmdidLocalsSearchPrevious           0x0000e025
#define cmdidLocalsSearchFocus              0x0000e026
#define cmdidLocalsShowOnlyFavorites        0x0000e027
#define cmdidLocalsShowFavoritesNames       0x0000e028
#define cmdidLocalsLast                     0x0000e03f

#define cmdidWatchFirst                     0x0000e040
#define cmdidWatchRealFuncEval              0x0000e040
#define cmdidWatchRealFuncEval1             0x0100e040
#define cmdidWatchRealFuncEval2             0x0200e040
#define cmdidWatchRealFuncEval3             0x0300e040
#define cmdidWatchRealFuncEval4             0x0400e040
#define cmdidWatchSearchDepth               0x0000e041
#define cmdidWatchSearchDepth1              0x0100e041
#define cmdidWatchSearchDepth2              0x0200e041
#define cmdidWatchSearchDepth3              0x0300e041
#define cmdidWatchSearchDepth4              0x0400e041
#define cmdidWatchSearchDepthList           0x0000e043
#define cmdidWatchSearchDepthList1          0x0100e043
#define cmdidWatchSearchDepthList2          0x0200e043
#define cmdidWatchSearchDepthList3          0x0300e043
#define cmdidWatchSearchDepthList4          0x0400e043
#define cmdidWatchSearchNext                0x0000e044
#define cmdidWatchSearchNext1               0x0100e044
#define cmdidWatchSearchNext2               0x0200e044
#define cmdidWatchSearchNext3               0x0300e044
#define cmdidWatchSearchNext4               0x0400e044
#define cmdidWatchSearchPrevious            0x0000e045
#define cmdidWatchSearchPrevious1           0x0100e045
#define cmdidWatchSearchPrevious2           0x0200e045
#define cmdidWatchSearchPrevious3           0x0300e045
#define cmdidWatchSearchPrevious4           0x0400e045
#define cmdidWatchSearchFocus               0x0000e046
#define cmdidWatchShowOnlyFavorites         0x0000e047
#define cmdidWatchShowOnlyFavorites1        0x0100e047
#define cmdidWatchShowOnlyFavorites2        0x0200e047
#define cmdidWatchShowOnlyFavorites3        0x0300e047
#define cmdidWatchShowOnlyFavorites4        0x0400e047
#define cmdidWatchShowFavoritesNames        0x0000e048
#define cmdidWatchShowFavoritesNames1       0x0100e048
#define cmdidWatchShowFavoritesNames2       0x0200e048
#define cmdidWatchShowFavoritesNames3       0x0300e048
#define cmdidWatchShowFavoritesNames4       0x0400e048
#define cmdidWatchLast                      0x0000e05f
...
#define cmdidToggleUserCode                 0x00007003 // deprecated
#define cmdidModulesWindowClearSearchFilter 0x00007006
#define cmdidModulesWindowFilterFocus       0x00007007
...
#define cmdidCopyWithSourcePaths            0x0000800c
#define cmdidGoToModule                     0x0000800d
#define cmdidCallStackTemplateArguments     0x0000800e

#define cmdidCallStackSearchNext            0x0000800f
#define cmdidCallStackSearchPrevious        0x00008010
#define cmdidCallStackSearchFocus           0x00008011
#define cmdidCallStackShowAllThreads        0x00008012
#define cmdidCallStackShowExternalCode      0x00008013
#define cmdidDeoptimizeFrame                0x00008014
// Datatip commands
...
#define cmdidCopyModuleName                         0x00000221
#define cmdidCopyModulePath                         0x00000222
#define cmdidCopyModuleDirectory                    0x00000223
#define cmdidCopyModuleSymbolFile                   0x00000224
#define cmdidCopyModuleVersion                      0x00000225
#define cmdidCopyModuleBaseAddress                  0x00000226
#define cmdidOpenFileLocationModule                 0x00000227
#define cmdidOpenFileLocationSymbols                0x00000228
...
#define cmdidSetDebuggerLogging             0x0000f005
...
#define cmdidReverseStepInto                   0x0000f011
#define cmdidReverseStepOver                   0x0000f012
#define cmdidReverseStepOut                    0x0000f013
#define cmdidReverseExecute                    0x0000f014
...
#define cmdidHotReload                      0x0000f017
#define cmdidHotReloadRestart               0x0000f018
#define cmdidHotReloadFileSave              0x0000f019
#define cmdidHotReloadSettings              0x0000f020
#define cmdidHotReloadMenuGroupExecution    0x0000f021
#define cmdidHotReloadMenuGroupSetting      0x0000f022
#define cmdidHotReloadMenuController        0x0000f023
#define cmdidHotReloadMenuGroupAnchor       0X0000f024
#define cmdidHotReloadOnFileSave            0X0000f025

// Breakpoint groups
// These commands reserve ranges of ids, do not re-use commands in these ranges

#define cmdidBreakpointsWindowAddToBreakpointGroupFirst     0x0000f026 // reserves 0xf026-0xf045
#define cmdidBreakpointsWindowAddToBreakpointGroupLast      0x0000f045
#define cmdidBreakpointsWindowRemoveFromBreakpointGroup     0x0000f046
#define cmdidBreakpointsWindowAddToNewBreakpointGroup       0x0000f047

#define cmdidAddToBreakpointGroupFirst                      0x0000f048 // reserves 0xf048-0xf067
#define cmdidAddToBreakpointGroupLast                       0x0000f067
#define cmdidRemoveFromBreakpointGroup                      0x0000f068
#define cmdidAddToNewBreakpointGroup                        0x0000f069
#define cmdidSetAsDefaultBreakpointGroup                    0x0000f06a
#define cmdidUnsetAsDefaultBreakpointGroup                 0x0000f06b

// Copilot
#define cmdidAnalyzeWithCopilot                                0x0000f070
