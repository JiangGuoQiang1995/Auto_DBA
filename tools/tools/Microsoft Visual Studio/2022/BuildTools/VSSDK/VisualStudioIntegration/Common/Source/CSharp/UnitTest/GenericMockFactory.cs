...
namespace Microsoft.VsSDK.UnitTestLibrary
{
    ...
    public class GenericMockFactory
    {
        ...
        static GenericMockFactory()
        {
            ...
            var assemblyName = new AssemblyName("MockFactoryAssembly");
        ...
        {
            return (BaseMock)Activator.CreateInstance(this.GetGeneratedType());
        }
        ...
        public Type GetGeneratedType()
        {
            ...
            if (null == this.generatedType)
                this.generatedType = CreateType(this.className, this.interfaces);
        ...
        public static Type CreateType(string className, Type[] interfaces)
        {
            ...
            var customAttribute = new CustomAttributeBuilder(comVisibleAttributeCtr, new object[] { true });
            ...
            foreach (Type t in typeList)
            {
                ...
                foreach (MethodInfo method in t.GetMethods())
                {
                    ...
                    var fullMethodName = string.Format(System.Globalization.CultureInfo.InvariantCulture,
                    ...
                    var offset = (method.ReturnType == typeof(void)) ? 0 : 1;
                    foreach (ParameterInfo paramInfo in parameters)
                    {
        ...
        {
            var sortedInterfaces = new SortedList<String, Guid>();
            ...
            var hash = "";
            foreach (var guid in sortedInterfaces.Keys)
            {
                hash = hash + guid;
            }
            return hash;
