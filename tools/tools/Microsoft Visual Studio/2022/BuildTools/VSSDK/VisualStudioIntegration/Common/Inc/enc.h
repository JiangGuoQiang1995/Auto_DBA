...
#ifndef __IDebugENCModule2_FWD_DEFINED__
#define __IDebugENCModule2_FWD_DEFINED__
typedef interface IDebugENCModule2 IDebugENCModule2;

#endif 	/* __IDebugENCModule2_FWD_DEFINED__ */
...
#ifndef __IDebugUpdateInMemoryPE3_FWD_DEFINED__
#define __IDebugUpdateInMemoryPE3_FWD_DEFINED__
typedef interface IDebugUpdateInMemoryPE3 IDebugUpdateInMemoryPE3;

#endif 	/* __IDebugUpdateInMemoryPE3_FWD_DEFINED__ */
...
#ifndef __IDebugENC176_FWD_DEFINED__
#define __IDebugENC176_FWD_DEFINED__
typedef interface IDebugENC176 IDebugENC176;

#endif 	/* __IDebugENC176_FWD_DEFINED__ */
...
static const HRESULT E_ENC_REBUILD_FAIL = MAKE_HRESULT(1, FACILITY_ITF, 0x0001);
static const HRESULT E_ENC_COMMIT_FAIL = MAKE_HRESULT(1, FACILITY_ITF, 0x0002);
static const HRESULT E_ENC_APPLY_FAIL = MAKE_HRESULT(1, FACILITY_ITF, 0x0003);
static const HRESULT E_ENC_INTERNAL_ERROR = MAKE_HRESULT(1, FACILITY_ITF, 0x0004);
static const HRESULT E_ENC_MODIFIED_MODULE_RELOADED = MAKE_HRESULT(1, FACILITY_ITF, 0x0005);
static const HRESULT E_ENC_NOT_SUPPORTED_DURING_INTEROP = MAKE_HRESULT(1, FACILITY_ITF, 0x0006);
static const HRESULT E_ENC_NOT_SUPPORTED_FOR_ATTACH = MAKE_HRESULT(1, FACILITY_ITF, 0x0010);
static const HRESULT E_VB_ENC_REBUILD_FAIL = MAKE_HRESULT(1, FACILITY_ITF, 0x0011);
static const HRESULT E_ENC_NOT_SUPPORTED_UNTIL_MODULE_LOADED = MAKE_HRESULT(1, FACILITY_ITF, 0x0012);
static const HRESULT S_ENC_ILREMAP_UNREACHABLE = MAKE_HRESULT(0, FACILITY_ITF, 0x0013);
static const HRESULT E_ENC_NOT_SUPPORTED_IN_RUNMODE = MAKE_HRESULT(1, FACILITY_ITF, 0x0014);
static const HRESULT E_ENC_NOT_SUPPORTED_BUILD_FAILED = MAKE_HRESULT(1, FACILITY_ITF, 0x0015);
static const HRESULT E_ENC_NOT_SUPPORTED_IN_STOPONEMODE = MAKE_HRESULT(1, FACILITY_ITF, 0x0016);
static const HRESULT E_ENC_COMPILAND_MODULES = MAKE_HRESULT(1, FACILITY_ITF, 0x0018);
static const HRESULT E_ENC_INSERT_MODULE = MAKE_HRESULT(1, FACILITY_ITF, 0x0019);
static const HRESULT E_ENC_ZICOMPILAND_SYMBOLS = MAKE_HRESULT(1, FACILITY_ITF, 0x0020);
static const HRESULT E_ENC_APPLY_INSERT_OBJECT = MAKE_HRESULT(1, FACILITY_ITF, 0x0021);
static const HRESULT E_ENC_NOT_SUPPORTED_FOR_MANAGED_COMPATIBILITY_MODE = MAKE_HRESULT(1, FACILITY_ITF, 0x0022);
...
typedef struct _ASTMTREMAP
    {
    GUID threadId;
    UINT32 methodToken;
    UINT32 oldMethodVersion;
    UINT32 oldILOffset;
    UINT32 newStartLine;
    UINT32 newStartCol;
    UINT32 newEndLine;
    UINT32 newEndCol;
    } 	ENCPROG_ACTIVE_STATEMENT_REMAP;
...
#ifndef __IDebugENCModule2_INTERFACE_DEFINED__
#define __IDebugENCModule2_INTERFACE_DEFINED__

/* interface IDebugENCModule2 */
/* [unique][uuid][object] */ 


EXTERN_C const IID IID_IDebugENCModule2;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("A58FF1F1-1FFF-44B4-A311-55D6675F4A0F")
    IDebugENCModule2 : public IDebugENCModule
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE ApplyENCUpdate2( 
            /* [size_is][in] */ __RPC__in_ecount_full(cbDeltaIL) BYTE *pbDeltaIL,
            /* [in] */ ULONG cbDeltaIL,
            /* [size_is][in] */ __RPC__in_ecount_full(cbDeltaMeta) BYTE *pbDeltaMeta,
            /* [in] */ ULONG cbDeltaMeta,
            ...
            /* [size_is][in] */ __RPC__in_ecount_full(cDeltaLines) LINEDELTA *pDeltaLines,
            /* [in] */ ULONG cDeltaLines,
            /* [size_is][in] */ __RPC__in_ecount_full(cRemapStatements) ENCPROG_ACTIVE_STATEMENT_REMAP *pRemapStatements,
            /* [in] */ ULONG cRemapStatements,
            /* [size_is][in] */ __RPC__in_ecount_full(cExceptionRanges) ENCPROG_EXCEPTION_RANGE *pExceptionRanges,
            /* [in] */ ULONG cExceptionRanges,
            /* [size_is][in] */ __RPC__in_ecount_full(cRemapMethods) UINT32 *pmdRemapMethods,
    ...
    typedef struct IDebugENCModule2Vtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            __RPC__in IDebugENCModule2 * This,
            /* [in] */ __RPC__in REFIID riid,
            /* [annotation][iid_is][out] */ 
            _COM_Outptr_  void **ppvObject);
        ...
        HRESULT ( STDMETHODCALLTYPE *ApplyENCUpdate2 )( 
            __RPC__in IDebugENCModule2 * This,
            /* [size_is][in] */ __RPC__in_ecount_full(cbDeltaIL) BYTE *pbDeltaIL,
            /* [in] */ ULONG cbDeltaIL,
            /* [size_is][in] */ __RPC__in_ecount_full(cbDeltaMeta) BYTE *pbDeltaMeta,
        ...
        END_INTERFACE
    } IDebugENCModule2Vtbl;

    interface IDebugENCModule2
    {
        CONST_VTBL struct IDebugENCModule2Vtbl *lpVtbl;
    };
...
#define IDebugENCModule2_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IDebugENCModule2_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IDebugENCModule2_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IDebugENCModule2_GetActiveStatementCount(This,cActiveStatements)	\
    ( (This)->lpVtbl -> GetActiveStatementCount(This,cActiveStatements) ) 

#define IDebugENCModule2_GetActiveStatements(This,celt,rgelt,pceltFetched)	\
    ( (This)->lpVtbl -> GetActiveStatements(This,celt,rgelt,pceltFetched) ) 

#define IDebugENCModule2_GetMetadataByteCount(This,cb)	\
    ( (This)->lpVtbl -> GetMetadataByteCount(This,cb) ) 

#define IDebugENCModule2_GetMetadataBytes(This,cb,pbMetadata,cbFetched)	\
    ( (This)->lpVtbl -> GetMetadataBytes(This,cb,pbMetadata,cbFetched) ) 

#define IDebugENCModule2_GetENCDebugInfo(This,ppENCDebugInfo)	\
    ( (This)->lpVtbl -> GetENCDebugInfo(This,ppENCDebugInfo) ) 

#define IDebugENCModule2_ApplyENCUpdate(This,pbDeltaIL,cbDeltaIL,pbDeltaMeta,cbDeltaMeta,pbDeltaPdb,cbDeltaPdb,pDeltaLines,cDeltaLines,pRemapStatements,cRemapStatements,pExceptionRanges,cExceptionRanges,pmdRemapMethods,cRemapMethods,pFileUpdates,cFileUpdates)	\
    ( (This)->lpVtbl -> ApplyENCUpdate(This,pbDeltaIL,cbDeltaIL,pbDeltaMeta,cbDeltaMeta,pbDeltaPdb,cbDeltaPdb,pDeltaLines,cDeltaLines,pRemapStatements,cRemapStatements,pExceptionRanges,cExceptionRanges,pmdRemapMethods,cRemapMethods,pFileUpdates,cFileUpdates) ) 

#define IDebugENCModule2_Initialize(This)	\
    ( (This)->lpVtbl -> Initialize(This) ) 


#define IDebugENCModule2_ApplyENCUpdate2(This,pbDeltaIL,cbDeltaIL,pbDeltaMeta,cbDeltaMeta,pbDeltaPdb,cbDeltaPdb,pDeltaLines,cDeltaLines,pRemapStatements,cRemapStatements,pExceptionRanges,cExceptionRanges,pmdRemapMethods,cRemapMethods,pFileUpdates,cFileUpdates)	\
    ( (This)->lpVtbl -> ApplyENCUpdate2(This,pbDeltaIL,cbDeltaIL,pbDeltaMeta,cbDeltaMeta,pbDeltaPdb,cbDeltaPdb,pDeltaLines,cDeltaLines,pRemapStatements,cRemapStatements,pExceptionRanges,cExceptionRanges,pmdRemapMethods,cRemapMethods,pFileUpdates,cFileUpdates) ) 
...
#endif 	/* __IDebugENCModule2_INTERFACE_DEFINED__ */
...
#ifndef __IDebugUpdateInMemoryPE3_INTERFACE_DEFINED__
#define __IDebugUpdateInMemoryPE3_INTERFACE_DEFINED__

/* interface IDebugUpdateInMemoryPE3 */
/* [unique][uuid][object] */ 


EXTERN_C const IID IID_IDebugUpdateInMemoryPE3;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("AE2FF3A4-2FA6-487C-AE74-9FB3D9276742")
    IDebugUpdateInMemoryPE3 : public IDebugUpdateInMemoryPE2
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE SetExceptionRanges( 
            /* [size_is][in] */ __RPC__in_ecount_full(cRanges) ENCPROG_EXCEPTION_RANGE *pRanges,
            /* [in] */ ULONG32 cRanges) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE SetRemapActiveStatements( 
            /* [size_is][in] */ __RPC__in_ecount_full(cRemapActiveStatements) ENCPROG_ACTIVE_STATEMENT_REMAP *pRemapActiveStatements,
            /* [in] */ ULONG32 cRemapActiveStatements) = 0;
    ...
    typedef struct IDebugUpdateInMemoryPE3Vtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            __RPC__in IDebugUpdateInMemoryPE3 * This,
            /* [in] */ __RPC__in REFIID riid,
            /* [annotation][iid_is][out] */ 
            _COM_Outptr_  void **ppvObject);
        ...
        HRESULT ( STDMETHODCALLTYPE *SetExceptionRanges )( 
            __RPC__in IDebugUpdateInMemoryPE3 * This,
            /* [size_is][in] */ __RPC__in_ecount_full(cRanges) ENCPROG_EXCEPTION_RANGE *pRanges,
            /* [in] */ ULONG32 cRanges);
        
        HRESULT ( STDMETHODCALLTYPE *SetRemapActiveStatements )( 
            __RPC__in IDebugUpdateInMemoryPE3 * This,
            /* [size_is][in] */ __RPC__in_ecount_full(cRemapActiveStatements) ENCPROG_ACTIVE_STATEMENT_REMAP *pRemapActiveStatements,
            /* [in] */ ULONG32 cRemapActiveStatements);
        
        END_INTERFACE
    } IDebugUpdateInMemoryPE3Vtbl;

    interface IDebugUpdateInMemoryPE3
    {
        CONST_VTBL struct IDebugUpdateInMemoryPE3Vtbl *lpVtbl;
    };
...
#define IDebugUpdateInMemoryPE3_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IDebugUpdateInMemoryPE3_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IDebugUpdateInMemoryPE3_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IDebugUpdateInMemoryPE3_GetMetadataEmit(This,ppMetadataEmit)	\
    ( (This)->lpVtbl -> GetMetadataEmit(This,ppMetadataEmit) ) 

#define IDebugUpdateInMemoryPE3_SetDeltaIL(This,pbIL,cbIL)	\
    ( (This)->lpVtbl -> SetDeltaIL(This,pbIL,cbIL) ) 

#define IDebugUpdateInMemoryPE3_SetDeltaPdb(This,pDeltaPdbStream)	\
    ( (This)->lpVtbl -> SetDeltaPdb(This,pDeltaPdbStream) ) 

#define IDebugUpdateInMemoryPE3_SetDeltaLines(This,pLineDeltas,cLineDeltas)	\
    ( (This)->lpVtbl -> SetDeltaLines(This,pLineDeltas,cLineDeltas) ) 

#define IDebugUpdateInMemoryPE3_GetENCDebugInfo(This,ppDebugInfo)	\
    ( (This)->lpVtbl -> GetENCDebugInfo(This,ppDebugInfo) ) 

#define IDebugUpdateInMemoryPE3_SetRemapMethods(This,pmdRemapMethodTokens,cRemapMethods)	\
    ( (This)->lpVtbl -> SetRemapMethods(This,pmdRemapMethodTokens,cRemapMethods) ) 

#define IDebugUpdateInMemoryPE3_SetFileUpdates(This,pFileUpdates,cFileUpdates)	\
    ( (This)->lpVtbl -> SetFileUpdates(This,pFileUpdates,cFileUpdates) ) 


#define IDebugUpdateInMemoryPE3_GetMetadataByteCount(This,cb)	\
    ( (This)->lpVtbl -> GetMetadataByteCount(This,cb) ) 

#define IDebugUpdateInMemoryPE3_GetMetadataBytes(This,cb,pbMetadata,cbFetched)	\
    ( (This)->lpVtbl -> GetMetadataBytes(This,cb,pbMetadata,cbFetched) ) 

#define IDebugUpdateInMemoryPE3_SetDeltaMetadata(This,pbMetadata,cbMetadata)	\
    ( (This)->lpVtbl -> SetDeltaMetadata(This,pbMetadata,cbMetadata) ) 


#define IDebugUpdateInMemoryPE3_SetExceptionRanges(This,pRanges,cRanges)	\
    ( (This)->lpVtbl -> SetExceptionRanges(This,pRanges,cRanges) ) 

#define IDebugUpdateInMemoryPE3_SetRemapActiveStatements(This,pRemapActiveStatements,cRemapActiveStatements)	\
    ( (This)->lpVtbl -> SetRemapActiveStatements(This,pRemapActiveStatements,cRemapActiveStatements) ) 
...
#endif 	/* __IDebugUpdateInMemoryPE3_INTERFACE_DEFINED__ */
...
/* interface __MIDL_itf_enc_0000_0033 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_enc_0000_0033_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_enc_0000_0033_v0_0_s_ifspec;
...
/* interface __MIDL_itf_enc_0000_0034 */
/* [local] */ 

#pragma warning(pop)


extern RPC_IF_HANDLE __MIDL_itf_enc_0000_0034_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_enc_0000_0034_v0_0_s_ifspec;
...
#ifndef __IDebugENC176_INTERFACE_DEFINED__
#define __IDebugENC176_INTERFACE_DEFINED__

/* interface IDebugENC176 */
/* [unique][uuid][object][local] */ 


EXTERN_C const IID IID_IDebugENC176;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("43CBD6B1-C3EB-4A97-8FC4-E7194D33CEE6")
    IDebugENC176 : public IUnknown
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE CancelApplyCodeChanges( 
            /* [in] */ IDebugProgram2 *pProgram,
            /* [in] */ BOOL waitForCompletion) = 0;
    ...
    typedef struct IDebugENC176Vtbl
    {
        BEGIN_INTERFACE
    ...
    interface IDebugENC176
    {
        CONST_VTBL struct IDebugENC176Vtbl *lpVtbl;
    };
...
#define IDebugENC176_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IDebugENC176_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IDebugENC176_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IDebugENC176_CancelApplyCodeChanges(This,pProgram,waitForCompletion)	\
    ( (This)->lpVtbl -> CancelApplyCodeChanges(This,pProgram,waitForCompletion) ) 
...
#endif 	/* __IDebugENC176_INTERFACE_DEFINED__ */
