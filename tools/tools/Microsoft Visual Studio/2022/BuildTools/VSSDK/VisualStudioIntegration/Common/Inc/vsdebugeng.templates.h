...
Abstract:
    ...
    when using the Visual Studio Debugger Engine (debugger back end) API.
...
namespace Microsoft {
    namespace VisualStudio {
        namespace Debugger {
            ...
            /// owner of a resource to automatically close the resource.
            /// </summary>
            template <class T>
...
#pragma warning(disable:28196)
                // According to analysis this should be _Ret_opt_ because there are cases (default construction) when m_p
                // is null. However for all usage it is non-null when this operator is used. 
...
#pragma warning(pop)
                ...
                // for closing the object is now in the hands of a different piece of code.
            ...
            private:
                ...
                // Call pWorkList.BeginExecution/Execute/Cancel instead of pWorkList->BeginExecution/Execute/Cancel
            ...
            /// ----------------------------------------------------------------------------
            /// <summary>
            /// CAutoDkmWorkListPtr holds a wrapper around a 'DkmWorkList*' to automatically cancel the
            ...
            public:
                ...
                static inline HRESULT GetOrCreateFactoryDataItem(_In_ TDkmType* pDkmObject, TDataItemFactory& dataItemFactory, _Deref_out_ TDataItem** ppDataItem)
                {
                    ...
                    *ppDataItem = nullptr;
                    ...
                    {
                        ATL::CComPtr<TDataItem> pNewInstance;
            ...
            template <typename T>
            T* begin(const DkmArray<T>& a)
            {
                return a.Members;
            }

            template <typename T>
            T* end(const DkmArray<T>& a)
            {
