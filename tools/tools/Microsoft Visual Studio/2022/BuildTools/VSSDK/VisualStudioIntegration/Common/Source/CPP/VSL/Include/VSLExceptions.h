...
public:
	...
	virtual HRESULT GetHRESULT() const
	{
		return ExceptionHRESULT::m_expValue;
	}
	...
	explicit ExceptionHRESULT(
		...
		int iLineNumber,
#endif
		const typename ExceptionHRESULT::ExtraDataType& extraData = ExtraDataTypeContainer_T::DefaultValue()):
			BaseClass(
				hr,
 #ifndef _VSL_NO_SOURCE_INFO
				strExpression,
...
public:
	...
	ExceptionWin32(
		...
		int iLineNumber,
#endif
		const typename ExceptionWin32::ExtraDataType& extraData = ExtraDataTypeContainer_T::DefaultValue()):
			BaseClass(
				dwCode,
 #ifndef _VSL_NO_SOURCE_INFO
				strExpression,
	...
	virtual HRESULT GetHRESULT() const
	{
		return HRESULT_FROM_WIN32(ExceptionWin32::m_expValue);
	}

	virtual DWORD GetWin32Error() const
	{
		return ExceptionWin32::m_expValue;
	}
};
