...
// [06/30/2021] Updating copies of vseeguids.h to conform to the VS vseeguids.h and not use these GUIDs
// [05/19/2017] We shouldn't be using these GUIDs in either 32 bit or 64 bit Visual Studio since
// we share PIAs across versions to keep managed code compatibility. These were created very early during
// first version of Visual Studio. The services are provided by msenv.dll that was never compiled to 64 bit before.
#ifdef UNUSED_WIN64
