...
function getCameraElement() {
    ...
    if (camera == null) {
        isOrtho = true;
        camera = document.elements.findElementByTypeId("Microsoft.VisualStudio.3D.OrthographicCamera");
    }
    return camera;
}

var cameraElement = getCameraElement();
var camWorldMatrix = getWorldMatrix(cameraElement);

if (isOrtho) {
    var coord = document.getCoordinateSystemMatrix();
    var relPos = math.getForwardVector(coord);
    relPos = math.transformNormal(camWorldMatrix, relPos);

    document.frameSelection(relPos[0], relPos[1], relPos[2], true);
}
else {
    var camPos = math.getTranslation(camWorldMatrix);
    document.frameSelection(camPos[0], camPos[1], camPos[2], false);
}
...
// SIG // tY1kP1jJfBkVCE+UU5duMnBiCJ7NzUGb40V66W1V3Kyg
...
// SIG // DQEJBDEiBCDo8+YsFQgG+h1s5KLMCG3WaOzzNKEz/nCy
// SIG // 7VFsqL1NiTBCBgorBgEEAYI3AgEMMTQwMqAUgBIATQBp
// SIG // AGMAcgBvAHMAbwBmAHShGoAYaHR0cDovL3d3dy5taWNy
// SIG // b3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAI32mdX3
// SIG // vzqU7jCgMgARuT8wXLF6DpI0ON9Ka7xhFWzZjue1jMcf
// SIG // dDrVqYgevu+B55WJ3J2rbkKaxj3YPes+sSLLK+T/LEwv
// SIG // F+21gXFZ3W3eDNtidRPDafL0gxekMeed6KRTQFKwoov0
// SIG // WVmL7mzYHm7aR4RU7MMyD11daaU4/aPQb/wvv5VBc4oz
// SIG // Koh1l19UQBOLNrToJ/5ZVwPi9q6WtfX0GQkGqqk7YJOM
// SIG // PIwhJB4GPXE41FlSgJ26Ab9GcJdQhBqClcN0E2bVjjAf
// SIG // SVkRugvCacpng5sz7S41fQhes32+n3Y5dS5IWL58LMog
// SIG // Qp3WS6cudae8QvHkWgmrgRRKJkyhgheUMIIXkAYKKwYB
// SIG // BAGCNwMDATGCF4Awghd8BgkqhkiG9w0BBwKgghdtMIIX
// SIG // aQIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBUgYLKoZIhvcN
// SIG // AQkQAQSgggFBBIIBPTCCATkCAQEGCisGAQQBhFkKAwEw
// SIG // MTANBglghkgBZQMEAgEFAAQgJWhHHnIat00lXicZ0kd8
// SIG // ZkuiSBoM3nxxbS/gCvFScBMCBmhwbNzY4hgTMjAyNTA4
// SIG // MTQxODMxNTMuMjE5WjAEgAIB9KCB0aSBzjCByzELMAkG
// SIG // A1UEBhMCVVMxEzARBgNVBAgTCldhc2hpbmd0b24xEDAO
// SIG // BgNVBAcTB1JlZG1vbmQxHjAcBgNVBAoTFU1pY3Jvc29m
...
// SIG // BgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgltz5
// SIG // fxz5MbRbpJoUbJh2nugEm6ECNgtM/hO7Y3jXkm8wgfoG
...
// SIG // BIICAAhdyzoRXIyZM3Nuz+fBpeWPSVqRtP+o+a65uw04
// SIG // 44zijAsXxTDHVVm2OJvgL52cWuYjKsv3XU3t//8zbx8J
// SIG // D0oi44cEKzt5Qr7SvnWUd6KHyavZLIk92DDPsYvria4N
// SIG // WRPcPzKZHgQ+tIq4/tdPhoFH1Nm4HNWiIs/ROh4PP0H8
// SIG // q0sPSGqpWfl5ILPLbcQ8lh/Aap6FN2bGg7VIKDQ0adIh
// SIG // 9VcvZAVFkTLFYnQYuYStoRpJj21xUTmVwm8gVKB+142X
// SIG // ARTMcPZ/iC9SGUg5c2EBkxLwGa5u4QiZv0KrEf3AnJ99
// SIG // CuK2dWAW137uldTXL9DzvOixIMTGD1DQTKNAB+I5yuaX
// SIG // APVKMyD2vZdOxrD+fqcfO7VsLx5SnQ7pNuCdr++SJYcE
// SIG // Y9PDqmenITunpj6AH50Zx6431LJK9FQ9WPLAF4wu23uT
// SIG // zJ86lGDjvaY6dojgnEQfpVuwFGEnycRMcAvlDFoBxZAy
// SIG // eICRgefcCB+0Q0lKFFhWYHFaDhtsL6H2wYe0/hHaBavS
// SIG // knqmN+T1E/xOYTgU2vZFOPZPmGUZLPeSaOgzwBmCRgd6
// SIG // jQDLaBLX7UwFPos/vw/tU/BaFKeqItkj9ZbU5YcN2OSA
// SIG // LxkywS+NuImFMqE0Bhh7INZzLS7oZeU6gt4oqmn5qbbz
// SIG // Ab0RRzMRyOobDJ3lZSn+/l3c0VYx
